...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        ...
        return new Comparator<Point>() {
            ...
            public int compare(Point o1, Point o2) {
                return comparePoints(Point.this, o1, o2);
                // TODO: implement something like the ccw(a, b, c) to compare two points b and c with the slope they make with a
            }
        };
    }

    private static int comparePoints(Point a, Point b, Point c) {
        double slope = (a.slopeTo(b) - a.slopeTo(c));
        if (slope < 0) return -1;
    ...
    public static void main(String[] args) {
        ...
        Point thirdPoint = new Point(4, 8);
        Point thirdPoint1 = new Point(5, 5);
        Point thirdPoint2 = new Point(2, 2);
        Point fourthPoint = new Point(7, 7);
        Point fifthPoint = new Point(19, 19);
        Point[] pointArray = new Point[] {
                firstPoint, secondPoint, fourthPoint, thirdPoint, thirdPoint1, thirdPoint2,
                fifthPoint
        };
        ...
        Arrays.sort(pointArray, secondPoint.slopeOrder());
